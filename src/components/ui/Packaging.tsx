...
export default function Packaging() {
  return (
    <section id="packaging" className="py-24 px-6 bg-slate-50 relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {packagingOptions.map((option, index) => (
            ...
            >
              <Card className="p-10 border-slate-200 hover:border-accent-cyan/30 transition-all duration-500 bg-white group h-full">
