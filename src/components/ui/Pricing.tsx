            ...
            >
              ...
              >
                ...
                <Button 
                  ...
                  className={`w-full py-4 rounded-xl font-black text-[10px] uppercase tracking-[0.2em] transition-all duration-500 ${
                    plan.popular ? 'neon-shadow-purple' : 'border-slate-200 hover:border-accent-indigo/30'
                  }`}
                >
                  Pilih Size {plan.price}
                </Button>
              </Card>
            </motion.div>
          );
